public class Student {
    ...
    public String getStudentInfo(){
        String getStudentInfo = ("Student Full Name: " + firstName + " " + lastName +"\n");
        getStudentInfo += ("Graduation Year: " + gradYear + "\n");
        getStudentInfo += ("Number Of Tests: " + testScoreCount + "\n");
        getStudentInfo += ("Average Test Score: " + averageTestScore() + "\n");
        getStudentInfo += ("Is passing: " + isPassing());
